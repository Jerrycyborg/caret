    ...
    async with aiosqlite.connect(get_db_path()) as db:
        ...
        query = """
            SELECT id, title, summary, prompt, task_class, execution_domain, reporting_target,
                   ...
                   support_category, support_severity, trigger_source,
    ...
    async with aiosqlite.connect(get_db_path()) as db:
        await db.execute(
            ...
            INSERT INTO tasks (
                ...
                support_category, support_severity, trigger_source, auto_fix_eligible,
                auto_fix_attempted, auto_fix_result, risk_level, next_suggested_action,
